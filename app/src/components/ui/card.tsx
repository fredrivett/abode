...
/** Container card with a bordered, shadowed layout. */
...
/** Header section of a card, supports an optional action column. */
...
/** Muted description text displayed in the card header. */
